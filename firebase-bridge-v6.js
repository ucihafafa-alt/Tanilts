(() => {
  'use strict';
  window.TANIL_BUILD = 'v6.2';
  console.info('TANIL build v6.2 loaded');
  ...
  function firebaseError(err) {
    ...
    const map = {
      ...
      'permission-denied': '[V6.2] Firestore чатны дүрэм зөвшөөрөөгүй байна. V6.2 Rules-ийг Publish хийсэн эсэхээ шалгана уу.'
    };
